    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="row has-feedback {{ $errors->has('group_name') ? ' has-error ' : '' }}">
                ...
                <div class="row has-feedback {{ $errors->has('group_logo') ? ' has-error ' : '' }}">
                ...
                {!! Form::button('Gruppe aktualisieren', array('class' => 'btn btn-success col-12','type' => 'submit' )) !!}
                {!! Form::close() !!}
            </div>
        </div>
    </div>
